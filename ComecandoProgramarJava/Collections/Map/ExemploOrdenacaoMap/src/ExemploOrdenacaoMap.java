...
public class ExemploOrdenacaoMap {
	...
	//Autor = Harari, Yuval Noah - Livro = nome: 21 Liçoes Para o século 21, páginas: 432
	...
	public static void main(String[] args) {
		...
		//usa o treeSet para trabalhar com os valores
...
class ComparatorNome implements Comparator<Map.Entry<String, Livro>>{
	...
	@Override
	public int compare(java.util.Map.Entry<String, Livro> l1, java.util.Map.Entry<String, Livro> l2) {
